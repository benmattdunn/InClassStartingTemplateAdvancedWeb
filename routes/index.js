...
/*
    Please note, that the complete code is avaliable at the bottom of the
    page, if you have errors due to brackets and the like, please use the
    code at the bottom to help you debug.
 */
...
router.get('/', function(req, res, next) {
    ...
    // OUR Rearrange Code Will go here
...
router.post('/', function(req, res, next){
    ...
    var position = 0; //Current position place holder
...
// REFERENCE CODE,
// incase you leave out something, or are having problems getting the project
// to work, the code is listed below that we will be creating.
/*
        ...
        task.save(function(err){
            ...
            if(err){
                ...
                //REDIRECT UPDATING THE LIST
                 res.redirect('/'); //doesn't have to be here.
            }
        });
    }
 });
